...
# Edited and updated by Iva Andreeva.
# NOTE: tensorflow_addons is deprecated and reaches end-of-life May 2024. Requires Python < 3.12 and Tensorflow < 2.14, as stated in https://github.com/tensorflow/addons
...
class SpecAugment():
    ...
    def freq_mask(self):
        ...
        for i in range(self.m_F):
            ...
            # TODO: Cite Edit from [:, f0:f0+f, :, :] to following
