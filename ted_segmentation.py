...
def load_audio(talk_num):
    ...
    return AudioSegment.from_wav(os.path.join(path, "datasets", "IWSLT23.tst2023.en-de", "benchmark_IWSLT-23.en-de", "benchmark", "en-de", "tst2023", "wav", f"ted_{talk_num}.wav"))
...
with open(os.path.join(path, "datasets", "IWSLT23.tst2023.en-de", "benchmark_IWSLT-23.en-de", "benchmark", "en-de", "tst2023", "IWSLT.TED.tst2023.en-de.yaml"), 'r') as stream:
    try:
        ...
        for segment in segments:
            ...
            audio_segment.export(os.path.join(save_path, f"{talk_num}_{segment_num}.wav"), bitrate="256k", format="wav")
